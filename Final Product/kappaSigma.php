...
<nav class="navbar navbar-expand-lg navbar-red">
  ...
  <div class="collapse navbar-collapse" id="navbarText">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link color-me" href="sigmaTauGamma.php">Sigma Tau Gamma</a>
      </li>
    </ul>
...
<div class="container">
  <div class="row">
    <div class="col">
      <img src="images/kappaSigma.jpg">
    </div>
    <div class="col">
      <h1>Kappa Sigma</h1>
    </div>
    <div class="col">
	<a href="https://www.kappasigma.org/"><button type="button" class="btn btn-primary">National Site</button></a>
    </div>
    <div class="col">
...
<table class="table table-striped">
  ...
  <tbody>
	<?php
		...
		$query = "select firstName, lastName from Member where fName = 'Kappa Sigma'";
