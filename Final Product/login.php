...
<html lang="en">
	...
	<body>
		...
		<h1 class="mt-3 mb-4 text-center">Fraternity Login</h1>
		
			
		
		<form action="login.php" method="post">
			<div class="fborder border border-secondary bg-light py-5 w-75 d-block mx-auto" style="border-style: groove;">
				...
				<div class="form-group">
					...
					<input class="form-control w-75 mx-auto" maxlength="20" name="username" placeholder="Enter Username" required="" type="text"><br>
	
					<label class="d-block text-center"> Password:</label>
					<input class="form-control w-75 mx-auto" maxlength="20" name="password" placeholder="Enter Password" required="" type="password"> 
				</div>
				
				<div class="form-group">
					<!-- Submit button -->
					<button type="submit" class="btn btn-primary btn-block mb-4 w-50 mx-auto">Sign in</button>

					<!-- Register button -->
					<div class="text-center">
						<p>Is your fraternity not listed?<br><a href='#' id='request'>Request an Account</a></p>
					</div>
				</div>
			</div>
