...
<div class="container">
  <div class="row">
    ...
    <div class="col">
	<a href="https://www.sae.net/"><button type="button" class="btn btn-primary">National Site</button></a>
    </div>
    <div class="col">
...
<table class="table table-striped">
  ...
  <tbody>
	<?php
		...
		$query = "select firstName, lastName from Member where fName = 'Sigma Alpha Epsilon'";
