...
<div class="container">
  <div class="row">
    <div class="col">
      <img src="images/alphaSigmaPhi.jpg">
    </div>
    <div class="col">
      <h1>Alpha Sigma Phi</h1>
    </div>
    <div class="col">
      <a href="https://alphasig.org/"><button type="button" class="btn btn-primary">National Site</button></a>
...
<table class="table table-striped">
  ...
  <tbody>
	<?php
		...
		$query = "select firstName, lastName from Member where fName = 'Alpha Sigma Phi'";
