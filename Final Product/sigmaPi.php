...
<div class="container">
  <div class="row">
    <div class="col">
      <img src="images/sigmaPi.jpg">
    </div>
    <div class="col">
      <h1>Sigma Pi</h1>
    </div>
    <div class="col">
      <a href="https://sigmapi.org/"><button type="button" class="btn btn-primary">National Site</button></a>
    </div>
    <div class="col">
...
<table class="table table-striped">
  ...
  <tbody>
	<?php
		...
		$query = "select firstName, lastName from Member where fName = 'Sigma Pi'";
